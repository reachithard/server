        ...
        public:
            void RdLock() {
                ...
                while (!success)
                {
                    ...
                    success = lk.compare_exchange_weak(tmp, tmp + 1, std::memory_order_acquire, std::memory_order_relaxed);
                }
            ...
            bool TryWrLock() {
                ...
                return tmp != 0 || lk.compare_exchange_weak(tmp, -1, std::memory_order_acquire, std::memory_order_release);
            }
